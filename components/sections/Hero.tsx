...
export default function Hero() {
  return (
    <section
      id="home"
      className="relative min-h-screen overflow-hidden pt-24 pb-16 md:pt-32 md:pb-24"
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
          ...
          >
            ...
            <motion.div variants={staggerChild} className="mb-6">
              <span className="inline-flex items-center gap-2 rounded-full border border-accent-maroon/15 bg-white/60 px-4 py-2 text-xs font-semibold tracking-widest text-accent-maroon shadow-sm backdrop-blur-sm dark:border-primary-beige/15 dark:bg-neutral-dark/40 dark:text-primary-beige">
            ...
            <motion.h1
              ...
              className="font-heading text-4xl font-bold leading-[1.1] tracking-tight text-neutral-dark sm:text-5xl md:text-6xl lg:text-[3.5rem] xl:text-6xl dark:text-primary-beige"
            >
              Helping You Build{" "}
            ...
            <motion.p
              variants={staggerChild}
              className="mt-6 max-w-xl text-base leading-relaxed text-accent-brown/70 sm:text-lg md:text-xl lg:mx-0 mx-auto dark:text-primary-beige/60"
            >
          ...
          >
            ...
            <div className="relative">
              ...
              <motion.div
                className="absolute -top-4 -right-4 rounded-2xl bg-white/90 p-4 shadow-lg backdrop-blur-sm sm:-right-8 dark:bg-neutral-dark/90"
                animate={{ y: [0, -8, 0] }}
              ...
              <motion.div
                className="absolute -bottom-4 -left-4 max-w-[200px] rounded-2xl bg-white/90 p-4 shadow-lg backdrop-blur-sm sm:-left-8 dark:bg-neutral-dark/90"
                animate={{ y: [0, -6, 0] }}
        ...
        >
          {[
            ...
            >
              <stat.icon className="mx-auto mb-3 h-6 w-6 text-accent-maroon dark:text-primary-beige/80" />
              <div className="text-3xl font-bold text-neutral-dark dark:text-primary-beige font-heading">
